      ...
      <main>
        <section className="wrapper" id='top'>
          ...
          <div className="arrRightTop" onClick={() => {
            ...
            console.log('movPage:', movPage);
            setSkip(movPage)
          }}><FontAwesomeIcon icon='chevron-right' /></div>
              ...
              return (
                <div className='boxCardFav'>
                  <Link to={`/character/${characterId}`} key={key}>
                    ...
                    <div className="front">
                      <img src={`${card.thumbnail.path}/standard_xlarge.${card.thumbnail.extension}`} alt="characters" />
                    </div>
                  </Link>
                  <button onClick={() => {
                    ...
                    Cookies.set('FavComics', fav, { expires: 15, secure: true })
                  }}  >
